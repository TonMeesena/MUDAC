...
---
```{r}
data$favor_om <- mutate(data$favor_om, 
                     if("OM filing party" =="Plaintiff" && decision == "Granted"|
                        "OM filing party" =="Defendant" && decision == "Denied"){"Plaintiff"
                       }else if("OM filing party"=="Defendant" && decision == "Granted"|
                                "OM filing party"=="Plaintiff" && decision == "Denied"){"Defendant"
                         }else{NA})

data$favor_tm <- mutate(data$favor_tm, 
                        #In favor of plaintiff
                        if("TM filing party" =="Plaintiff" && motion_type == "Motion to Dismiss" && 
                        outcome == "Dismissed"| "TM filing party" =="Plaintiff" && motion_type == "Motion for Summary
                        Judgment" && outcome == "Summary Judgment" | "TM filing party" =="Defendant" && 
                        motion_type == "Motion to Dismiss" && outcome != "Dismissed"| "TM filing party" =="Defendant"
                        && motion_type == "Motion for Summary Judgment" && outcome != "Summary Judgment" ){"Plaintiff"
                       }
                       #in favor of Defendant
                       else if("TM filing party" =="Defendant" && motion_type == "Motion to Dismiss" && 
                        outcome == "Dismissed"| "TM filing party" =="Defendant" && motion_type == "Motion for Summary
                        Judgment" && outcome == "Summary Judgment" | "TM filing party" =="Plaintiff" && 
                        motion_type == "Motion to Dismiss" && outcome != "Dismissed"| "TM filing party" =="Plaintiff"
                        && motion_type == "Motion for Summary Judgment" && outcome != "Summary Judgment"){"Defendant"
                         }else{NA})
```
